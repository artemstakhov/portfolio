...
const Hero = ({ data }: HeroProps) => {
  return (
    <section className="pt-20 md:pt-24 py-8 md:py-16 flex items-center bg-gradient-to-br from-background via-background to-primary/10 relative overflow-hidden">
