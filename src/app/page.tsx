...
export default function Home() {
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      <Certificates title={data.certificatesTitle} data={data.certificates} />
      <Personal title={data.personalTitle} interestsTitle={data.interestsTitle} locationTitle={data.locationTitle} data={data.personal} />
